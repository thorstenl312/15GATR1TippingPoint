...
void forwardPID(float pos, int maxPower = 400, int tim = 50, float decel = 2, int lowSpeed = 40, bool closeEarly = false, int closer = 400);
...
void turnLeft(float pos, int maxSpeed = 320, int tim = 50);
void turnRight(float pos, int maxSpeed = 320, int tim = 50);

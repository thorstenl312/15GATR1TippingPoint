...
void forwardPID(float pos, int maxPower = 400, int tim = 50, float decel = 2.4, int lowSpeed = 70, bool closeEarly = false, int closer = 400);
void forwardPID2(float pos, int maxPower = 430, int tim = 50);
void backwardPID(float pos, int maxPower = 400, int tim = 50, float decel = 2, int lowSpeed = 70);
...
void turnLeft(float pos, int maxSpeed = 250, int tim = 50);
void turnRight(float pos, int maxSpeed = 250, int tim = 50);
